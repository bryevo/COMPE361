...
//Takes forever to compile because it searches through all the lists of chains until it finds the end word.  These lists are dynamically added to the List of chains and has an expontential growth rate.